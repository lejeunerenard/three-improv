...
var name = package.name || basename // eslint-disable-line
var spec = npa(name)
...
if (!package.description) {
  exports.description = yes ? '' : prompt('description', 'A threejs experiment')
}
...
if (!s.test || s.test === notest) {
  ...
  s.lint = 'standard | snazzy'
  s.dev = 'budo index.js:bundle.js --live --open'
  s["build:prod"] = 'browserify . -o bundle.js'
}
return cb(null, s)
}
...
if (!package.keywords) {
  exports.keywords = yes ? '3d,experiment' : prompt('keywords', '3d,experiment', function (s) {
